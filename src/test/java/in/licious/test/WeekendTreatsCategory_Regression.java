...
public class WeekendTreatsCategory_Regression extends BaseTest{

@Test
public void validateWeekendTreatsTest() throws Exception
{
	...
	Helper.customWait(8);
			...
			try {
				...
				for (WebElement imgElement : imagesList) {
					if (imgElement != null) {
						...
						//helper.highlightElementList(driver, imagesList);
           ...
           // System.out.println(itemTitle.get(i).getText());
            ...
            if(itemTitle.get(i).getText().contains(itemTitle.get(count).getText()));
            {
            	...
            	{
            		etest.log(LogStatus.FAIL,"Product name is Not Shown");
            	}
            }
            }
			}
