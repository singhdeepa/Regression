...
public class Chicken_Sanity extends BaseTest {
	@Test
	public void validateChickenTest()
	{
		...
		helper.highlightElement(driver, newlogin.getMobileNumber());
				...
				String expChickenLink="Chicken";
				   String actChickenLink=driver.findElement(By.xpath("//a[@href='/chicken']")).getText();
				   Assert.assertEquals(actChickenLink, expChickenLink);
				   etest.log(LogStatus.PASS,"Chicken Link is validated successfully");
				   Helper.customWait(5);
				   driver.findElement(By.xpath("//a[@href='/chicken']")).click();
