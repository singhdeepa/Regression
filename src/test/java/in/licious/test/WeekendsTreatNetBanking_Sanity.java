...
public class WeekendsTreatNetBanking_Sanity extends BaseTest{
	String excelPath="C:\\Users\\Deepa\\git\\SeleniumWebDriver\\ExcelData\\loginCredentials11.xls";
	@Test()
	public void weekendsTreatNetBankingTest() throws Exception
	{
...
payButton.click();
Helper.customWait(5);
String RaxorPatTitle="Razorpay Bank";
Helper.customWait(2);
Helper.switchOnWindowBasedOnTitle(driver, RaxorPatTitle);
Helper.customWait(5);
